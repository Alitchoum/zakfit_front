...
//        
//        return [
//            InfosItem(color: .bleu, picto: "ruler", title: "Taille", value: "\(user.size!) cm"),
//            InfosItem(color: .vert, picto: "scales", title: "Poids", value: "\(user.weight!) kg"),
//            InfosItem(color: .violet, picto: "cake", title: "Age", value: "\(user.age!) ans")
//        ]
//    }
